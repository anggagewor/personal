...
class RedeemVoucherAction
{
    ...
    public function execute(string $code, int $transactionId, float $subtotal): Voucher
    {
        ...
        $this->voucherRepo->incrementUsage($voucher->id);
        $this->voucherRepo->recordRedemption($voucher->id, $transactionId);
